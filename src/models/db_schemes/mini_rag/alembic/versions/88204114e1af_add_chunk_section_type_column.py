"""Add chunk_section_type column

Revision ID: 88204114e1af
Revises: db17a0f62a47
Create Date: 2025-12-01 12:54:32.893140
...
revision: str = '88204114e1af'
down_revision: Union[str, Sequence[str], None] = 'db17a0f62a47'
...
def upgrade() -> None:
    ...
    sa.Column('asset_doc_type', sa.String(), nullable=False),
    ...
    sa.Column('chunk_doc_type', sa.String(), nullable=False),
